...
namespace MeuhedetDentist
{
    public class DataContext
    {
        ...
        public DataContext()
        {
            ...
            {
                 new turns {NumTurn=1,IsAvailableTurn=true,DateTimeTurn = new DateTime(22,12,2022), NumRoom=03},
                 new turns {NumTurn=2,IsAvailableTurn=false,DateTimeTurn = new DateTime(20,12,2022), NumRoom=03},
                 new turns {NumTurn=3,IsAvailableTurn=true,DateTimeTurn = new DateTime(22,12,2022), NumRoom=04},
            };
        }
    }
}
